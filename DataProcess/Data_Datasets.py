...
# edges = pd.read_csv('..\Data\A unified data\GM12878_intra\GM12878\edge\merge\chr1.csv',header=None)
# nodes = pd.read_csv('..\Data\A unified data\GM12878_intra\GM12878\\node\\nodes_chr1.csv',header=None)
...
class DataReader:
    ...
    def read_words(self,min_count):
        word_frequency = dict()
        data = pd.read_csv(self.inputFileName,header=None)
        self.sentences_count = len(data)
        for idk in range(len(data)):
            line = data.iloc[idk]
            for word in line:
                self.token_count += 1
        ...
        for w, c in word_frequency.items():
            ...
            wid += 1
        self.word_frequency = word_frequency_new
